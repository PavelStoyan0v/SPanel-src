      ...
      <div class="container-fluid">
                    ...
                    <div class="card mb-3" id = "container">
                      <div class="card-header">
                        <i class="fa fa-table"></i> Учители <i class="fa fa-remove remove"></i></div>
                      <div class="card-body">
                        <div class="table-responsive">
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php
                                   ...
                                   $teachers = $userDb->select("teacher", "*");
                                   for ($i=0; $i <count($teachers) ; $i++) {
                                     echo "<tr id =  student_".$i.">";
                                     echo "<th class = 1>". htmlspecialchars($teachers[$i]["name"])."</th>";
                                     echo "<th class = 2>". htmlspecialchars($teachers[$i]["fName"])."</th>";
                                     echo "<th class = 3>". htmlspecialchars($teachers[$i]["email"])."</th>";
                                     echo "<th class = 4>". htmlspecialchars($teachers[$i]["phone"])."</th>";
                                      echo "<th class = '5 hidden_td'>" . htmlspecialchars($teachers[$i]["id"])."</th>";
                                     echo "</tr>";
                                   }
                                ?>
                            </tbody>
         ...
         <script>
               ...
               redMessage("Моля изберете ученик от таблицата");
                     ...
                     $.post("listfunctionality.php",
                         ...
                         function(data, status)
                         {
                           console.log(data);
                           if (data == 0) {
                             greenMessage("Вие изтрихте успешно учителите");
                           }else if (data == 1) {
                             redMessage("Този учител има клас и не може да бъде изтрит");
                           }
                         });
                     }
             ...
             $("tr").click(function () {
               ...
               if(helper[0][id[1]] == 0){
                 ...
                 trHolder.push(tr);
                 emails.push(studentInformation[2])
                 console.log(studentInformation[4]);
                 ...
                 var emailIndex = emails.indexOf(studentInformation[2]);
                 var trindex = trHolder.indexOf(tr);
                 console.log(index);
                 if (index >= 0 && trindex>=0 && emailIndex >=0) {
