...
<?php
  ...
  $user = $db->getUserById(58);
  $subscriptionid = $db->insertSubscription("active", date("Y-m-d"), date_create(date("Y-m-d"))->add(new DateInterval("P1M"))->format("Y-m-d"), $user);
  echo "Успешно подновяване на абонамент.";
?>
</p>
